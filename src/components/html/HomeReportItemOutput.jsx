export const HomeReportItemOutput = ({ item, idx }) => {
	return (
		<table className="w-full border-collapse border border-gray-300 mt-2 text-center text-sm">
			...
			<tr>
				...
				<th className="border border-gray-300 px-2 py-1 w-24">진행률</th>
			</tr>
			</thead>
			<tbody>
			<tr>
				...
				<td className="border border-gray-300 px-2 py-1">{item.percent}</td>
			</tr>
			</tbody>
		</table>
	);
