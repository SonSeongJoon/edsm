...
const ReporterGiftShow = ({ product }) => {
	const {
		title,
		content,
		startDate,
		...
		<div>
			...
			<div className="border p-2 rounded-lg border-gray-300">
				<div className="flex flex-col">
					<div className="flex">
						<h1 className="font-bold mr-2 sm:text-md text-xm">항목 : </h1>
						<p
					...
					<div className="flex items-center mt-1">
						<h1 className="font-bold mr-2 sm:text-md text-xm">금액 : </h1>
						<p className="text-gray-600 text-sm sm:text-md">{price}</p>
					</div>
					<div className="flex items-center mt-1">
						<h1 className="font-bold mr-2 sm:text-md text-xm">비고 : </h1>
...
export default ReporterGiftShow;
