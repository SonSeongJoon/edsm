...
const LimitExcessShow = ({ product }) => {
  const { title, content, startDate, price, dept, name, file, corporation } = product;
  const date = new Date()
      ...
      <div className='border p-2 rounded-lg border-gray-300'>
        <div className='flex flex-col'>
          <div className='flex items-center mt-1'>
            <h1 className='font-bold mr-2 sm:text-md text-xm'>지출날짜 : </h1>
            <p className='text-gray-600 text-sm sm:text-md'>{startDate}</p>
          </div>
          <div className='flex'>
            <h1 className='font-bold mr-2 sm:text-md text-xm'>지출사유 : </h1>
            <p
          ...
          <div className='flex items-center mt-1'>
            <h1 className='font-bold mr-2 sm:text-md text-xm'>예상비용: </h1>
...
export default LimitExcessShow;
