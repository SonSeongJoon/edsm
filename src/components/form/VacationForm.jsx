                ...
                <div>
                  <div className='flex-col border sm:p-5 p-2 rounded-lg shadow-lg text-xm sm:text-md'>
                    ...
                    <div className='mt-1 flex-col '>
                      <div className='text-sky-500 text-xm sm:text-sm mb-2'>{vacation.isHalfDay ? '오전/오후 반차 표시를 제목에 작성해주세요!' : null}</div>
                      <div className='flex items-center'>
                        <label className='block sm:text-md text-xm font-bold mr-2' htmlFor={`vacationReason${index}`}>
                          휴가사유
                        </label>
                        <input
                          type='text'
